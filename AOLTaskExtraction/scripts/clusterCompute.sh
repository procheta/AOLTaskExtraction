...
#  do 
    java -cp $CP LucheseImplementation.WeightedClustering /home/procheta/NetBeansProjects/AOLTaskExtraction/src/LucheseImplementation/init.properties 0.3 0.2  
#  done
# done 
